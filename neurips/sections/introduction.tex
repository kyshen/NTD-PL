...
data analysis and signal processing \citep{Kolda2009Tensor,
...
settings, the latent signal may be well organized by a low-rank Tucker tensor
...
its chosen backbone ranks fixed while learning a response that
